...
public abstract class MagicRecyclerAdapter<T> extends RecyclerView.Adapter<MagicRecyclerAdapter.VH> {
    /**
     * 自定义点击监听接口
     * @param <S>
     */
    public interface ListItemClickListener<S> {
        void onItemClick(S s,int position);
        void onItemLongClick(S s,int position);
    }
    /**
     * 自定义点击监听接口
     * @param <S>
    ...
    protected List<T> itemList;//列表数据



    public MagicRecyclerAdapter(List<T> itemList) {
        ...
        vh.setItemListener(new VH.ItemListener() {
            ...
            public void onClick(int p) {
                if(listItemClickListener!=null){
                    listItemClickListener.onItemClick(itemList.get(p),p);
                }
            ...
            public void onLongClick(int p) {
                if(listItemClickListener!=null){
                    listItemClickListener.onItemLongClick(itemList.get(p),p);
                }
                if(listItemHolderClickListener!=null){
